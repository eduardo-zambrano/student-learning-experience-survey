...
Building on this distinction, and drawing on the TEval framework for multidimensional evaluation of teaching (Austin et al., 2025), the committee adopted the following five motions:
...
4. **Report Likert-scale results as frequency distributions** — raw counts together with percentages — excluding the use of means and medians. Guidance for the proper interpretation of these results is provided in this report.
