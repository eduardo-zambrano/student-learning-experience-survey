...
1. [Respect](#respect) (tone, dignity)
2. [Fairness](#fairness) (equity, consistency)
3. [Approachability](#approachability) (access, availability)

*Structural — how the course is experienced as a whole:*

4. [Coherence](#coherence) (purposefulness, connection)

*Environmental — what the classroom feels like as a shared space:*

5. [Participatory Climate](#participatory-climate) (conditions for engagement)
6. [Inclusivity](#inclusivity) (sense of belonging)
...
**What it captures:** Whether the student could see connections between course elements — that what happened in class, what was assigned, and what was assessed were recognizably related.
...
**What it captures:** Whether the classroom environment supports multiple modes of active engagement — asking questions, sharing idea and/or resources, discussing with peers, and making mistakes without penalty.
