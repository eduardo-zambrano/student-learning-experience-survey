...
**Third**, it recommends discontinuing the use of the open-ended questions in the **Student Learning Experience Survey**. Substantive open-ended questions remain a key component of the companion [Formative Learning Feedback](https://eduardo-zambrano.github.io/formative-learning-feedback/) proposal, where they serve their intended developmental purpose.

The proposal also incorporates three companion documents addressing: (1) scoring, reporting, and visualization guidelines; (2) guidance for evaluation of instruction, including a teaching effectiveness rubric and appropriate and inappropriate uses of the survey data; and (3) implementation details.
