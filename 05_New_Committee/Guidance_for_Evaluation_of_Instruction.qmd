...
Evidence for evaluating teaching comes from three sources: the instructor (e.g., CV, syllabi, course materials, student work samples, reflection), peers or observers (e.g., meeting with instructor, class observation, review of student materials), and students (e.g., Student Perceptions of Learning Experience, letters from students). The sections that follow describe each dimension, the guiding questions evaluators should consider, the sources of evidence appropriate to that dimension, and — where applicable — the limitations of particular evidence sources.
...
This dimension requires disciplinary expertise to evaluate. It is assessed through peer review (syllabi review, class observation, review of course materials) and instructor self-report (reflection), not through student surveys. The Student Perceptions of Learning Experience does not assess this dimension.
:::
...
::: {.callout-note title="Note"}
This dimension requires pedagogical expertise to evaluate. It is assessed through peer observation, review of course materials, and instructor reflection, not through student surveys. The Student Perceptions of Learning Experience does not assess this dimension.
:::
...
**Sources of evidence:** Syllabi, reflection, class observation, **Student Perceptions of Learning Experience**, letters from students.

This is the only dimension assessed through the **Student Perceptions of Learning Experience (SPLE)**, which asks students to report on six aspects of class climate:

- **Regard for Students** — Dignity in how the instructor interacts with students, and regard for students as persons.
- **No Differential Enforcement of Expectations** — Equitable treatment and consistent application of standards.
...
- **Welcoming Learning Environment** — Whether students feel they belong in the class.
...
Departments are not required to add questions to the Student Perceptions of Learning Experience. The six university-wide items are designed to provide a comprehensive assessment of class climate, and many departments will find them sufficient.
...
::: {.callout-note title="Note"}
This dimension is assessed through review of student work, analysis of learning outcomes, and instructor reflection, not through student surveys. The Student Perceptions of Learning Experience does not assess this dimension. While it may seem natural to ask students how much they learned, perceived learning does not track actual learning. In a controlled experiment, Deslauriers et al. ([2019](https://doi.org/10.1073/pnas.1821936116)) found that students who learned *more* (as measured by test performance) reported feeling they had learned *less*, and vice versa. Uttl, White, and Gonzalez ([2017](https://doi.org/10.1016/j.stueduc.2016.08.007)), in a comprehensive meta-analysis, found that the correlation between student evaluation ratings and student learning is effectively zero. A "perceived learning" item would thus measure neither the learning environment nor actual learning, while carrying the same bias vulnerabilities as other evaluative items.
:::
...
::: {.callout-note title="Note"}
This dimension is assessed through the candidate's reflective narrative and through longitudinal review of course materials and student outcomes. The Student Perceptions of Learning Experience does not assess this dimension, though SPLE results over time may inform the candidate's reflection.
:::
...
::: {.callout-note title="Note"}
This dimension is assessed through the candidate's CV, reflective narrative, meeting with the instructor, and letters from students — not through the Student Perceptions of Learning Experience.
:::
...
::: {.callout-note title="Note"}
This dimension is assessed through the candidate's CV and reflective narrative. The Student Perceptions of Learning Experience does not assess this dimension.
:::
...
| Developing | Proficient | Expert |
|---|---|---|
| Class climate discourages student motivation or self-efficacy. Does not effectively create a welcoming learning environment. Consistently negative student reports of instructor access or interaction. Little attempt to address concerns voiced by students. | Class climate promotes student motivation. Fosters a welcoming learning environment with regard for students as persons. No consistently negative student reports of instructor access or interaction. Instructor articulates some lessons learned through student feedback. | Climate promotes motivation, self-efficacy, ownership of learning. Instructor models welcoming language and behavior. Fosters an open learning environment that promotes student-student and student-instructor dialogue. Student feedback on instructor access and interaction is generally positive. Instructor seeks and is responsive to student feedback. |
