...
Evidence for evaluating teaching comes from three sources: the instructor (e.g., CV, syllabi, course materials, student work samples, reflection), peers or observers (e.g., meeting with instructor, class observation, review of student materials), and students (e.g., Student Learning Experience Survey, letters from students). The sections that follow describe each dimension, the guiding questions evaluators should consider, the sources of evidence appropriate to that dimension, and — where applicable — the limitations of particular evidence sources.
...
This dimension requires disciplinary expertise to evaluate. It is assessed through peer review (syllabi review, class observation, review of course materials) and instructor self-report (reflection), not through student surveys. The Student Learning Experience Survey does not assess this dimension.
:::
...
::: {.callout-note title="Note"}
This dimension requires pedagogical expertise to evaluate. It is assessed through peer observation, review of course materials, and instructor reflection, not through student surveys. The Student Learning Experience Survey does not assess this dimension.
:::


### §8.3.6. Dimension 3: Class Climate {#sec-class-climate-guidance}

This dimension is about the extent to which the class climate is respectful, supportive, and cooperative, whether it encourages motivation and engagement for all students, whether all students feel included, how student-student and student-instructor dialogue are fostered, what the students' views of their learning experiences are, and how the instructor has sought student feedback and used it to inform their teaching.

**Sources of evidence:** Syllabi, reflection, class observation, **Student Learning Experience Survey**, letters from students.

This is the only dimension assessed through the **Student Learning Experience Survey (SLES)**, which asks students to report on six aspects of class climate:

- **Respect** — Dignity and courtesy in how the instructor interacts with students.
- **Fairness** — Equitable treatment and consistent application of standards.
- **Approachability** — Perceived accessibility of the instructor for help outside of class.
- **Coherence** — Whether the student could see connections between course elements.
- **Participatory Climate** — Whether the classroom environment supports multiple modes of active engagement.
- **Inclusivity** — Whether students feel they belong in the class.

#### §8.3.6.1. Interpreting Student Learning Experience Survey results

Evaluators and candidates should interpret SLES results with care, following the scoring, reporting, and visualization guidelines established in @sec-scoring-reporting. Key principles include:

- **Frequency distributions, not averages.** SLES responses are ordered categorical data. They must not be averaged, and evaluators should examine the full distribution of responses, not any summary statistic.
- **Raw counts, not percentages.** With the class sizes typical of most courses, percentages create a misleading impression of precision.
- **No cross-comparisons.** SLES results must not be compared across instructors, courses, departments, or disciplines. Differences in scores may reflect demographic biases, course characteristics, or nonresponse patterns rather than differences in the learning environment.
...
Even when student survey items are framed as experiential reports about class climate — as in the SLES — rather than as evaluative judgments about teaching effectiveness, evaluators must be mindful of the inherent limitations of student evaluation data. These include, but are not limited to, the following factors ([Stark, 2026](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6193538)):
...
Departments are not required to add questions to the Student Learning Experience Survey. The six university-wide items are designed to provide a comprehensive assessment of class climate, and many departments will find them sufficient.
...
- **Closed-ended, structured items only.** Department-associated questions must be closed-ended items on the five-point Likert scale. Open-ended questions are not permitted on the summative instrument — for the same reasons they were removed from the university-wide items. Questions that invite unstructured commentary (e.g., "What could be changed about this course?") belong in the formative learning feedback process offered through the CTLT, not on the SLES.
...
::: {.callout-note title="Note"}
This dimension is assessed through review of student work, analysis of learning outcomes, and instructor reflection, not through student surveys. The Student Learning Experience Survey does not assess this dimension. While it may seem natural to ask students how much they learned, perceived learning does not track actual learning. In a controlled experiment, Deslauriers et al. ([2019](https://doi.org/10.1073/pnas.1821936116)) found that students who learned *more* (as measured by test performance) reported feeling they had learned *less*, and vice versa. Uttl, White, and Gonzalez ([2017](https://doi.org/10.1016/j.stueduc.2016.08.007)), in a comprehensive meta-analysis, found that the correlation between student evaluation ratings and student learning is effectively zero. A "perceived learning" item would thus measure neither the learning environment nor actual learning, while carrying the same bias vulnerabilities as other evaluative items.
:::
...
::: {.callout-note title="Note"}
This dimension is assessed through the candidate's reflective narrative and through longitudinal review of course materials and student outcomes. The Student Learning Experience Survey does not assess this dimension, though SLES results over time may inform the candidate's reflection.
:::
...
::: {.callout-note title="Note"}
This dimension is assessed through the candidate's CV, reflective narrative, meeting with the instructor, and letters from students — not through the Student Learning Experience Survey.
:::
...
::: {.callout-note title="Note"}
This dimension is assessed through the candidate's CV and reflective narrative. The Student Learning Experience Survey does not assess this dimension.
:::
